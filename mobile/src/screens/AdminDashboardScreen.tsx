...
export default function AdminDashboardScreen() {
  ...
  return (
    <ScreenContainer>
      ...
      <Text style={layout.sectionTitle}>Veículos no Pátio</Text>

      <FlatList
        data={dashboard?.veiculos_no_patio ?? []}
        ...
        ListEmptyComponent={<Text style={layout.emptyText}>Nenhum veículo no pátio</Text>}
      />
    </ScreenContainer>
  );
}
